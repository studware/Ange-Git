...
{
    static void AddCoeff(int c1, int c2, int op, string[][] bigDoubleArray)
    {
    ...
    static void Main()
    {
        Console.WriteLine("Write a method that adds, subtracts or multiplies two polynomials.");
  ...
  /*     string[][] jagged = new string[3][];
    ...
    */
        ...
        while (!int.TryParse(strNum = Console.ReadLine(), out oper) || oper < 1||oper>3);
        do
        {
        ...
        AddCoeff(n1, n2, oper,jagged);      // call the method to sum the polynomials
