...
internal class FilterByPrice
{
    ...
    private static void Main()
    {
        ...
        Console.WriteLine("The input data and the result data are in the Resources folder\n(files Product.txt and Results.txt respеctively.");
        Console.WriteLine("Products' names have been generated using random string generator\nof latin alphabet and digits 0....9.");
        double lowerPrice;
        double upperPrice;
