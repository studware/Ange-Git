...
public class TheHashTable<K, T> : IEnumerable<KeyValuePair<K, T>>
{
    ...
    public T this[K key]
    {
        ...
        set
        {
            ...
            {
                throw new ArgumentException("There is no element with such a key");
            }
            else
            {
                bool isFind = false;
    ...
    public void Add(K key, T value)
    {
        ...
        while (next != null)
        {
            if (next.Value.Key.Equals(key))
            {
                throw new ArgumentException("The key exists");
            }
            next = next.Next;
        }
