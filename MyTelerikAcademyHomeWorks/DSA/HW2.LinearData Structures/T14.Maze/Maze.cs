...
namespace T14.Maze
{
    ...
    static class Maze
    {
        ...
        static void Main()
        {
            Console.WriteLine("In labyrinth of size N x N some of its cells are empty (0), some are full (x).");
            Console.WriteLine("We can move from an empty cell to another empty cell if they share common wall.");
            Console.WriteLine("Calculate and fill the minimal distance from start position (*)");
            Console.WriteLine("to any other cell in the array. Use 'u' for all unreachable cells.\n");
