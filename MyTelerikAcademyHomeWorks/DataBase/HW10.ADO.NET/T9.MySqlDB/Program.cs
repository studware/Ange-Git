...
namespace T9.MySqlDB
{
    ...
    public class Program
    {
        public static void Main()
        {
            ...
            using (dbConnection)
            { 
                int newBook = AddNewBookToDBTable(dbConnection, "Stas and Nelly", "Henrik Senkevich", DateTime.Parse("2014.02.01"), 4567878657712);
                int newBook1 = AddNewBookToDBTable(dbConnection, " Foucault's Pendulum", "Umberto Eco", DateTime.Parse("1988.10.18"), 1234473820123);
                int newBook2 = AddNewBookToDBTable(dbConnection, "Learning Java", "Unknown", DateTime.Parse("2000.09.12"), 6778547890123);
